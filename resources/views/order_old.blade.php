                                ...
                                <div class="order-price-tbl-row __header">
                                    <div class="order-price-tbl-row-i u-Flex-grow-2">
                                        ...
                                        <div class="order-price-subttl __L brown">{{$package[0]->package_name}}
                                            <div class="order-price-ttl gray __mobile">Name <span class="order-price-ttl-arrow"></span> {{$order->subgallery->name}}</div>
                                        </div>
                                    ...
                                    <div class="order-price-tbl-row-i u-Flex-grow-6 __desktop">
                                        <div class="order-price-ttl gray">Name <span class="order-price-ttl-arrow"></span> {{$order->subgallery->name}}</div>
                                    </div>
                                                ...
                                                <div class="order-wrap">
                                                    <div class="order-preview">
                                                        ...
                                                        <div class="order-price-tbl-row-i u-Flex-grow-6 order-preview-cnt __digital-product-image">
                                                            @foreach($product->personImages() as $image)
                                                        ...
                                                        <div class="order-download-wrap order-price-tbl-row-i u-Flex-grow-2 js-get-info-zip-cnt __digital-product" @if(! $order->isDigitalZipPrepared())style="display: none" @endif>
                                                            <a href="{{ $order->present()->zipDigitalUrl() }}" class="product-card-btn js_zip-download" download="download">Download all photos  <br><span class="hidden-xs">(zip file: advanced)</span></a>
                                    ...
                                    <div class="order-price-tbl-row-i u-Flex-grow-2">
                                        ...
                                        <div class="order-price-subttl __L brown">{{$product->name}}
                                            ...
                                            @elseif($product->isDownloadable())
                                                <div class="order-download-wrap order-price-tbl-row-i u-Flex-grow-2 js-get-info-zip-cnt" @if(! $order->isDigitalZipPrepared())style="display: none" @endif>
                                                    <a href="{{ $order->present()->zipDigitalUrl() }}" class="product-card-btn js_zip-download" download="download">Download all photos
